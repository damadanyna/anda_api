...
create table if not exists fournisseur(
    ...
    localisation_ int not null,
    fourn_name varchar(150) null, 
    fourn_email varchar(150) null, 
    fourn_nif varchar(150) null, 
    fourn_stat varchar(150) null, 
    fourn_tel text null,
    fourn_pass text null, 
    fourn_status boolean not null,
    fourn_img_log_middle varchar(60) not null,
    fourn_img_bg varchar(60) not null,
    fourn_img_log_big varchar(60) not null,
